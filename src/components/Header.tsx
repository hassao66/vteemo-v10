...
const Header: React.FC = () => {
  ...
  return (
    <header className="vitimo-header px-2 md:px-4 lg:px-6 py-2 md:py-3 sticky top-0 z-50">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        {/* Logo and Menu */}
        <div className={`flex items-center space-x-2 md:space-x-4 ${isRTL ? 'space-x-reverse' : ''}`}>
          <button 
            onClick={() => setShowMobileMenu(!showMobileMenu)}
            className="lg:hidden p-2 hover:bg-dark-tertiary rounded-lg transition-colors"
          >
        ...
        {/* Search Bar */}
        <form onSubmit={handleSearch} className="flex-1 max-w-2xl mx-2 md:mx-4 lg:mx-8">
